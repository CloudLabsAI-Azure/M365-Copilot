...
- Checking the increasing types of communication channels
...
- **Regulatory compliance**: Most organizations must comply with some type of regulatory compliance standard as part of their normal operating procedures. These regulations often require organizations to implement some type of scoping or oversight process for messaging that is appropriate for their industry. For example:
...
1. Within some time, your policy will be created, and you can select **Close** to close the flyout page.

    ![](./media/compliance-policy-created.png)

    >**Note:** It might take up to an hour to activate your policy.
...
1. On the flyout page:
    ...
    - If you have a .txt file that includes a list of messages to detect, select **Upload a file containing messages to test** option, and then select the **Upload file** to upload your text file.
