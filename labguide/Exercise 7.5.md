# Exercise 5.5: Reviewing Security and Compliance in Copilot Using Audit (Read Only)
...
1. On the **Audit** page, configure the search using the following conditions on the **New Search** tab.
    ...
    - **Users:** Select this box and start typing the name of the users you want to display search results for. The audit log entries for the selected activities performed by the users you select in this box are displayed in the list of results. Leave this box blank to return entries for all users (and service accounts) in your organization.

1. Select **Search** to run the search.

1. The audit log search will begin. When the search is completed, audit records are displayed on the page. Select a record to display a flyout page with detailed properties.

    ![](./media/audit-search.png)

1. The screen appears, presenting all the record entries of the required type.
