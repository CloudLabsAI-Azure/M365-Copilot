...
1. Open **Teams** and go to the chat with a user named **Spektra Admin**.
...
1. Select the **Copilot** icon from the top right corner to use Copilot in the provided chat.

    ![](./media/teams-chat-copilot.png)

1. Here you can provide prompts like listing action points from the chat, summarizing the chat, etc. as per your needs. A sample prompt is given below, along with the output delivered by **Copilot**.
