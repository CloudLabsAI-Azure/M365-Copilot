# Exercise 2.4: Reviewing Security and Compliance in Copilot Using Customer Keys (Read Only)

In this exercise, you will examine how Customer Keys bolsters security and compliance in Microsoft 365 Copilot. Customer Keys allow organizations to control their own encryption keys, which enhances data protection and helps meet regulatory requirements. This feature complements existing encryption methods like BitLocker and SSE, ensuring that sensitive data remains secure.
